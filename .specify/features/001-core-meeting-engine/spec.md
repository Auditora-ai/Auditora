...
**Created**: 2026-03-22
**Status**: Draft
**Input**: Phase 1 of Auditora.ai — live process elicitation with auto-diagramming

## User Scenarios & Testing

### User Story 1 - Live Process Diagramming (Priority: P1)

As a BPM consultant, I start a Auditora.ai session with a meeting link. A bot joins my video call, listens to the conversation, and auto-generates a BPMN process diagram in real-time. I see nodes appear as process steps are discussed, and I can confirm or reject them.
...
**Why this priority**: The teleprompter is what makes Auditora.ai different from "recording + AI summary." It guides the conversation to produce a complete diagram.
...
**Why this priority**: The multi-session workflow mirrors how real BPM consulting works and differentiates Auditora.ai from single-meeting tools.
