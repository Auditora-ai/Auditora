...
import { SimulationHub } from "@simulations/components/SimulationHub";

export async function generateMetadata() {
	return { title: "Simulaciones" };
}
		...
		<div className="flex flex-col gap-6 p-6">
			<div>
				<h1 className="text-2xl font-semibold text-foreground">
					{t("app.menu.simulations")}
				</h1>
				<p className="mt-1 text-sm text-muted-foreground">
					Simulaciones tipo caso Harvard generadas a partir de tus procesos y riesgos reales.
				</p>
			</div>
			<SimulationHub
				templates={templates}
