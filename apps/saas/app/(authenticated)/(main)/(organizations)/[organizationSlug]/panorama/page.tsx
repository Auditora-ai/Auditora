...
export async function generateMetadata({
	...
	return { title: `${t("title")} — ${activeOrganization?.name ?? ""}` };
}
...
export default async function PanoramaPage({
	...
	const sessionActivity: ActivityItemWithSort[] = recentSessions.map((s) => ({
	...
	const evalActivity: ActivityItemWithSort[] = recentEvaluations
