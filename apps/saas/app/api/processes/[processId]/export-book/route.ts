...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* Cover */
  .cover { text-align: center; padding: 80px 40px; border-bottom: 3px solid #2563EB; margin-bottom: 40px; }
  ...
  .tag { display: inline-block; background: #EFF6FF; color: #2563EB; font-size: 12px; padding: 2px 8px; border-radius: 4px; margin: 2px; }
