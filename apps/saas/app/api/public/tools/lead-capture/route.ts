...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const toolUrl = `https://aiprocess.me/tools/${toolUsed}`;
    sendEmail({
      to: email.trim().toLowerCase(),
      subject: `Your ${displayName} result is ready — aiprocess.me`,
      html: `
        <div style="font-family: 'Geist', system-ui, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 20px;">
          ...
          <p style="color: #334155; line-height: 1.6;">Thanks for using aiprocess.me's free ${displayName}. Your result has been generated and is ready to view.</p>
          ...
          <p style="color: #64748B; font-size: 14px;"><strong>Did you know?</strong> aiprocess.me can generate BPMN diagrams, SIPOC, RACI matrices, and process audits <em>live during your meetings</em>. The AI joins your video call and does everything automatically.</p>
          <a href="https://aiprocess.me" style="color: #2563EB; font-size: 14px;">Learn more about aiprocess.me &rarr;</a>
        </div>
      `,
