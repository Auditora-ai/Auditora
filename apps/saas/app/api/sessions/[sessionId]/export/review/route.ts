...
<style>
	...
	* { box-sizing: border-box; margin: 0; padding: 0; }
	...
	.cover-badge { display: inline-flex; align-items: center; gap: 6px; background: #EFF6FF; color: #2563EB; padding: 6px 16px; border-radius: 100px; font-size: 12px; font-weight: 600; margin-bottom: 32px; }
	...
	.cover-stat .num { font-size: 28px; font-weight: 700; color: #2563EB; }
	...
	h2 { font-size: 18px; font-weight: 700; color: #0F172A; padding-bottom: 8px; border-bottom: 2px solid #2563EB; margin-bottom: 16px; }
	...
	.step-num { width: 24px; height: 24px; border-radius: 50%; background: #2563EB; color: white; font-size: 11px; font-weight: 700; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 2px; }
	.step-body { flex: 1; }
	...
	/* Summary box */
	.summary-box { background: #EFF6FF; border: 1px solid #BFDBFE; border-radius: 8px; padding: 16px; margin-bottom: 16px; }
		...
		<div class="lane-body">
			${nodes.map((n) => {
				...
				<div class="card-header">
					<div class="card-icon" style="background:${n.nodeType.includes("GATEWAY") ? "#EAB308" : n.nodeType === "START_EVENT" ? "#16A34A" : n.nodeType === "END_EVENT" ? "#DC2626" : "#2563EB"}">${n.label?.charAt(0) || "?"}</div>
					<div>
