		...
		<div className="flex h-[calc(100vh-10rem)] flex-col max-w-3xl mx-auto">
			...
			>
							...
							{PROMPT_SUGGESTIONS.map((suggestion, index) => {
								...
								return (
									<Button
										...
										className="group h-auto gap-2 rounded-2xl p-4 text-center bg-background"
									>
					...
					>
						<div
							className={cn(
								...
								message.role === "user"
									? "whitespace-pre-wrap bg-accent"
									: "bg-secondary prose prose-sm",
							)}
						>
				...
				{(status === "streaming" || status === "submitted") && (
					<div className="flex justify-start">
						<div className="flex max-w-2xl items-center gap-2 rounded-lg bg-muted px-4 py-2 text-foreground">
			...
			>
				<Textarea
					...
					className="min-h-8 border bg-background rounded-2xl focus:outline-hidden focus-visible:ring-0 shadow-none p-6 pr-14"
					onKeyDown={(e) => {
