...
import { Play, BarChart3, Users, ShieldAlert } from "lucide-react";

const ease = [0.22, 1, 0.36, 1] as [number, number, number, number];

const features = [
	{ id: "feature1", icon: Play },
	{ id: "feature2", icon: BarChart3 },
	{ id: "feature3", icon: Users },
	{ id: "feature4", icon: ShieldAlert },
];
...
export function EvaluationsClient({ saasUrl }: { saasUrl?: string }) {
					...
					>
						{features.map((feature, i) => {
							...
							return (
								...
								>
									<div className="flex items-center justify-center w-12 h-12 rounded-xl bg-[#00E5C0]/10 text-[#00E5C0] mb-4">
