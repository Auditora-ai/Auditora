		...
		<section ref={sectionRef} id="how-it-works" className="py-16 sm:py-20 lg:py-28 bg-[#0A1428]">
			<div className="container max-w-4xl">
				...
				<div className="hiw-timeline relative max-w-xl mx-auto">
					...
					<div
						ref={lineRef}
						className="absolute left-[23px] sm:left-[27px] top-[24px] sm:top-[28px] bottom-[24px] sm:bottom-[28px] w-[2px] bg-[#00E5C0] origin-top scale-y-0 z-0 hidden sm:block"
					/>
							...
							return (
								<div key={step.key} className="hiw-step flex gap-4 sm:gap-6 relative z-[1]">
									...
									<div className="relative z-10 shrink-0">
										<div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center bg-[#0A1428] bg-gradient-to-br from-[#00E5C0]/15 to-[#00E5C0]/15 border border-[#00E5C0]/30">
