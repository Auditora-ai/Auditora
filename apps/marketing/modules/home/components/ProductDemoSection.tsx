								...
								<div className="grid grid-cols-1 md:grid-cols-3 md:divide-x divide-[#334155]">
									...
									<div className="p-4 bg-white border-b md:border-b-0 border-[#334155]">
										<svg viewBox="0 0 300 150" className="w-full" fill="none">
											...
											<rect x="80" y="55" width="80" height="40" rx="4" stroke="#2563EB" strokeWidth="1.5" fill="#EFF6FF" />
											<text x="120" y="79" textAnchor="middle" className="text-[8px]" fill="#2563EB" fontFamily="system-ui">{t("home.demo.scene4.nodeMgr")}</text>
											<rect x="200" y="55" width="80" height="40" rx="4" stroke="#2563EB" strokeWidth="1.5" fill="#EFF6FF" strokeDasharray="4 3" />
											<text x="240" y="79" textAnchor="middle" className="text-[8px]" fill="#2563EB" fontFamily="system-ui">{t("home.demo.scene4.nodeVp")}</text>
										</svg>
									</div>
									...
									<div className="p-4">
										...
										<div className="space-y-2">
											<div className="scene-animate">
												<p className="text-[10px] text-[#2563EB] mb-0.5">{t("home.demo.scene3.consultantLabel")}</p>
							...
							<div className="bg-card border rounded-2xl overflow-hidden">
								...
								<div className="p-8">
									<svg viewBox="0 0 600 180" className="w-full" fill="none">
										...
										<rect x="100" y="65" width="120" height="50" rx="6" stroke="#2563EB" strokeWidth="1.5" fill="#EFF6FF" />
										<text x="160" y="94" textAnchor="middle" className="text-[10px]" fill="#2563EB" fontFamily="system-ui">{t("home.demo.scene4.nodeSubmit")}</text>
										<rect x="245" y="75" width="30" height="30" rx="3" transform="rotate(45 260 90)" stroke="#D97706" strokeWidth="1.5" fill="#FFFBEB" />
										<rect x="320" y="25" width="120" height="50" rx="6" stroke="#2563EB" strokeWidth="1.5" fill="#EFF6FF" />
										<text x="380" y="54" textAnchor="middle" className="text-[10px]" fill="#2563EB" fontFamily="system-ui">{t("home.demo.scene4.nodeMgr")}</text>
										<rect x="320" y="105" width="120" height="50" rx="6" stroke="#2563EB" strokeWidth="1.5" fill="#EFF6FF" />
										<text x="380" y="134" textAnchor="middle" className="text-[10px]" fill="#2563EB" fontFamily="system-ui">{t("home.demo.scene4.nodeVp")}</text>
										<rect x="465" y="75" width="30" height="30" rx="3" transform="rotate(45 480 90)" stroke="#D97706" strokeWidth="1.5" fill="#FFFBEB" />
