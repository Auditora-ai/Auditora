      ...
      <section className="border-t border-border bg-[#0F172A] px-4 py-16 text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-8 text-[#94A3B8]">
            {isEs
              ? "Auditora.ai se une a tu videollamada, guia tus preguntas con un teleprompter, y genera el diagrama BPMN en tiempo real."
              : "Auditora.ai joins your video call, guides your questions with a teleprompter, and generates the BPMN diagram in real-time."}
          </p>
