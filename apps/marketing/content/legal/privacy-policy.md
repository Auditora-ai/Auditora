...
| --- | --- | --- | --- |
| `session_token` | Essential | 30 days | Authentication and session management |
| `NEXT_LOCALE` | Essential | Session | Stores your language preference |
| `cookie_consent` | Essential | 1 year | Remembers your cookie preferences |
| `sidebar-collapsed` | Essential | 1 year | Stores UI layout preference |
| `scan_session` | Essential | 24 hours | Maintains anonymous tool scan sessions |
| `_ga` / `_gid` | Analytics | Up to 2 years | Google Analytics for aggregated usage statistics |
| `ph_*` | Analytics | 1 year | Product analytics (PostHog) |
...
**Auditora.ai (by Prozea)**
Email: **privacy@auditora.ai**
